...
export async function GET(req: NextRequest) {
  try {
    ...
    // Dashboard Admin sekarang selalu "cleanOnly: true" (hanya Data Clean).
    const result = await aggregateDashboard(filter, { includeStudents: false, bypassCache, cleanOnly: true });
